...
namespace CustomerAPI3.Controllers
{
    ...
    public class CustomerController3 : ControllerBase
    {
        private readonly ILogger<CustomerController3> _logger;

        /// <summary>
        /// CTOR
        /// </summary>
        /// <param name="logger">ILogger</param>
        public CustomerController3(ILogger<CustomerController3> logger)
        {
            this._logger = logger;
        }
